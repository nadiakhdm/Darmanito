        ...
        <div className="container mx-auto relative">
          <div className="lg:flex md:flex block w-full ">
            <div id="responsiveVideoWrapper" className="relative  w-full h-100 rounded-lg    mt-4 ">
              <div className={Play ? "relative featur-img w-80  hidden " : "relative featur-img w-80  lg:mx-24 md:mx-4 mx-auto "}>
            ...
            <div className="mt-12  w-full lg:px-0 md:px-0 px-12">
              <h3 className="my-4  border-r-4 ml-12 px-3  text-blue-500 font-bold border-green-400 ">درباره درمانیتو</h3>
              <p className="my-4 text-xs leading-loose  lg:pl-32 md:pl-12  ">
